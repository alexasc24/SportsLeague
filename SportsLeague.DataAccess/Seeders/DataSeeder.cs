...

{
...

    {
...

        {
            ...
            new() { Name="América de Cali", City="Cali", Stadium="Pascual Guerrero", FoundedDate=new DateTime(1944, 11, 14)},

            new() { Name="Deportivo Cali", City="Cali", Stadium="Deportivo Cali", FoundedDate=new DateTime(1945, 11, 14)},

            new() { Name="Junior FC", City="Barranquilla", Stadium="Metropolitano", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Millonarios FC", City="Bogotá", Stadium="El Campín", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Independiente Santa Fe", City="Bogotá", Stadium="El Campín", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Deportes Tolima", City="Ibagué", Stadium="Manuel Murillo Toro", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Atlético Bucaramanga", City="Bucaramanga", Stadium="Alfonso López", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Once Caldas", City="Manizales", Stadium="Palogrande", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Deportivo Pasto", City="Pasto", Stadium="Departamental Libertad", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Deportivo Pereira", City="Pereira", Stadium="Hernán Ramírez Villegas", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Águilas Doradas", City="Rionegro", Stadium="Alberto Grisales", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Boyacá Chicó FC", City="Tunja", Stadium="La Independencia", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Jaguares de Córdoba", City="Montería", Stadium="Jaraguay", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Alianza Valledupar FC", City="Valledupar", Stadium="Armando Maestre", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Fortaleza FC", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Llaneros FC", City="Villavicencio", Stadium="Bello Horizonte", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Cúcuta Deportivo", City="Cúcuta", Stadium="General Santander", FoundedDate=new DateTime(1945, 11, 14) },

            new() { Name="Internacional de Bogotá", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate=new DateTime(1945, 11, 14) },
